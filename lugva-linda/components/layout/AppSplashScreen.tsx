          ...
          >
            ...
            {PERIMETER_PARTICLES.map((p) => (
              <motion.div
                ...
                className="bg-foreground/25 dark:bg-primary-foreground/35 pointer-events-none absolute rounded-full"
              />
            ))}
            ...
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
              {OUTER_LEFT_FLOW.map((tp) => (
                <motion.div
                  ...
                  className="bg-primary/80 absolute rounded-full shadow-[0_0_6px_var(--primary)]"
                />
              ))}
            ...
            <motion.div
              ...
              className="bg-primary/15 pointer-events-none absolute h-96 w-96 -translate-y-4 rounded-full blur-3xl"
            />
            ...
            <div className="relative z-20 flex flex-col items-center justify-center px-4">
              ...
              <div className="relative mb-7 flex h-24 w-32 items-center justify-center sm:h-28 sm:w-36">
                <svg
                ...
                >
                  ...
                  <motion.path
                    ...
                    className="fill-black drop-shadow-[0_0_10px_rgba(0,0,0,0.4)] drop-shadow-[0_0_20px_rgba(0,0,0,0.25)] filter dark:fill-white dark:drop-shadow-[0_0_12px_#ffffff] dark:drop-shadow-[0_0_24px_#ffffff] dark:drop-shadow-[0_0_45px_rgba(255,255,255,0.9)]"
                    initial={{ opacity: 0 }}
                    animate={{
                  ...
                  <motion.path
                    ...
                    fill="none"
                    className="stroke-black drop-shadow-[0_0_8px_rgba(0,0,0,0.5)] filter dark:stroke-white dark:drop-shadow-[0_0_10px_#ffffff] dark:drop-shadow-[0_0_22px_#ffffff]"
                ...
                >
                  <div className="h-20 w-20 rounded-full bg-black/75 shadow-[0_0_35px_rgba(0,0,0,0.5)] blur-xl dark:bg-white dark:shadow-[0_0_35px_#ffffff]" />
                </motion.div>
              </div>
              ...
              >
                <TypoLogo className="text-foreground h-8 w-auto tracking-wide sm:h-10" />
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-muted/60 mt-6 h-[2px] w-28 overflow-hidden rounded-full sm:w-36"
              >
                <motion.div
                  initial={{ x: '-100%' }}
                  animate={{ x: '0%' }}
                  ...
                  className="bg-primary h-full w-full rounded-full shadow-[0_0_8px_var(--primary)]"
                />
              </motion.div>
            </div>
          </motion.div>
