...
export const PageHeader = ({ title, onCancel, onClose }: PageHeaderProps) => {
  return (
    <header className="border-border bg-background/95 supports-backdrop-filter:bg-background/70 sticky top-0 z-10 flex w-full items-center gap-2 border-b px-3 pt-(--safe-area-top) pb-3 backdrop-blur">
